    ...
    public class BookEntityConfiguration : IEntityTypeConfiguration<Book>
    {
        public void Configure(EntityTypeBuilder<Book> builder)
        {
            ...
            builder.HasData(
                ...
                new { Id = 8, Title = "Makbet", Isbn = "9788496509290", PublisherId = 2, State = State.Active, CreateDateTime = DateTimeProvider.CurrentDateTime, LastUpdateDateTime = DateTimeProvider.CurrentDateTime },
